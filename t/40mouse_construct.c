...
int main(int argc, char *argv[])
{
  ...
  key.type = -1;
  key.modifiers = 0;
  termkey_construct_mouse(tk, &key, TERMKEY_MOUSE_PRESS, 1, 1, 1);
  ...
  key.type = -1;
  key.modifiers = 0;
  termkey_construct_mouse(tk, &key, TERMKEY_MOUSE_DRAG, 1, 1, 2);
  ...
  key.type = -1;
  key.modifiers = 0;
  termkey_construct_mouse(tk, &key, TERMKEY_MOUSE_RELEASE, 0, 1, 3);
  ...
  termkey_construct_mouse(tk, &key, TERMKEY_MOUSE_PRESS, 1, 11, 11);
  ...
  key.type = -1;
  key.modifiers = 0;
  termkey_construct_mouse(tk, &key, TERMKEY_MOUSE_PRESS, 1, 20, 20);
  ...
  key.modifiers = 0;
  termkey_construct_mouse(tk, &key, TERMKEY_MOUSE_RELEASE, 0, 20, 20);
  ...
  key.modifiers = 0;
  key.type = -1;
  termkey_construct_mouse(tk, &key, TERMKEY_MOUSE_PRESS, 1, 30, 30);
  ...
  key.type = -1;
  termkey_construct_mouse(tk, &key, TERMKEY_MOUSE_RELEASE, 0, 0, 0);
  ...
  key.type = -1;
  termkey_construct_mouse(tk, &key, TERMKEY_MOUSE_PRESS, 1, 300, 500);
